...
const LoginComponent = ({closeCompo}) => {
    ...
    return (
        <div className="loginComponent">
            ...
            <img style={{ width: "100px", height: "80px" }} src={image} className="card-img-top" alt="..." />
            ...
            <Link style={{ width: "95%", marginTop: "5px" }} to="#">
                <button onClick={() => {NavigateToAdmin()}} style={{ width: "100%", color: "white", fontWeight: "bold" }} type="button" class="btn btn-info">Log in</button>
            </Link>
        </div>
    )
}
